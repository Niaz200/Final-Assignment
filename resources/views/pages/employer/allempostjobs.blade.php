													...
													<tr>
														...
														<td class="px-6 py-4">
															<div class="table-card">
																...
																<form action="{{ route('delemjobpost', $jobpost->id) }}" method="POST">
																@csrf
																@method('DELETE')
																	...
																	<a href="{{ route('showempost', $jobpost->id) }}" class="btn btn-md btn-light-success px-3 me-2"><i class="fa-solid fa-eye"></i></a>
