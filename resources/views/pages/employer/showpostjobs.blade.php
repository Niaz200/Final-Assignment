...
{{--}}
											@php
                                            	$totaljobs = App\Models\Postjobs::where('user_id', $showjobs->id)->get();
                                        	@endphp --}}
																...
																<div class="row align-items-center justify-content-between gy-4">
																	...
																	<div class="col-xl-6 col-lg-6 col-md-6">
																		<div class="cdtx-infr-box">
																			...
																			<div class="cdtx-infr-captions">
																				<h5>{{$showjobs->user->profile->mobile}}</h5>
																				<p>Phone No.</p>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-xl-6 col-lg-6 col-md-6">
																		<div class="cdtx-infr-box">
																			...
																			<div class="cdtx-infr-captions">
																				<h5>{{ date('Y', strtotime($showjobs->user->profile->birthday))}}</h5>
																				<p>Build</p>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-xl-6 col-lg-6 col-md-6">
																		<div class="cdtx-infr-box">
																			...
																			<div class="cdtx-infr-captions">
																				<h5>{{$showjobs->user->profile->job_title}}</h5>
																				<p>Company Type</p>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-xl-6 col-lg-6 col-md-6">
																		<div class="cdtx-infr-box">
																			...
																			@php
																				...
																				$works=(implode(',', $showjobs->user->profile->work_type));
