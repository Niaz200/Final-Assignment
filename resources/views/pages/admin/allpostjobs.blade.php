...
<div class="dashboard-tlbar d-block mb-4">
						<div class="row">
							<div class="colxl-12 col-lg-12 col-md-12">
								<h1 class="mb-1 fs-3 fw-medium">All Pending Job Posts</h1>
											...
											<table class="table">
												...
												@foreach ($jobposts as $key => $jobpost )
													...
													<tr>
														...
														<td>{{ $jobpost->created_at->diffForHumans() }}</td>
														<td>{{ $jobpost->status }}</td>
														
														<td class="px-6 py-4">
															<div class="table-card">

																<form action="{{ route('deljobpost', $jobpost->id) }}" method="POST">
																@csrf
																@method('DELETE')
																	...
																	<a href="{{ route('showpost', $jobpost->id) }}" class="btn btn-md btn-light-success px-3 me-2"><i class="fa-solid fa-eye"></i></a> 
																{{--	<a href="{{ route('editjobpost', $jobpost->id) }}" class="btn btn-md btn-light-success px-3"><i class="fa-solid fa-edit"></i></a> --}}
