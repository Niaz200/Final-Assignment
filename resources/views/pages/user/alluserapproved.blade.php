...
<div class="dashboard-tlbar d-block mb-4">
						<div class="row">
							<div class="colxl-12 col-lg-12 col-md-12">
								<h1 class="mb-1 fs-3 fw-medium">Approved Jobs</h1>
                                                            ...
                                                            <div class="jbs-list-head">
                                                                <div class="jbs-list-head-thunner">
                                                                    ...
                                                                    <div class="jbs-list-job-caption">
                                                                        <div class="jbs-job-types-wrap"><span class="label text-success bg-light-success">{{ $appjob->job_type }}</span></div>
                                                                        <div class="jbs-job-title-wrap"><h4><a href="job-detail.html" class="jbs-job-title">{{ $appjob->job_title }}</a></h4></div>
                                                                        <div class="jbs-job-mrch-lists">
                                                                            <div class="single-mrch-lists">
                                                                                <span>{{ $appjob->compa_name }}</span>.<span><i class="fa-solid fa-location-dot me-1"></i>{{ $appjob->location }}</span>.
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="jbs-list-head-middle">
                                                                    <div class="elsocrio-jbs"><span class="text-sm-muted">Apply {{$appjob->created_at->format('d M Y')}}</span></div>
                                                                </div>
                                                                <div class="jbs-list-head-middle">
                                                                    <div class="elsocrio-jbs"><span class="text-sm-muted text-light  bg-success  py-2 px-3 rounded">{{ $appjob->status }}</span></div>
                                                                </div>
                                                                <div class="jbs-list-head-last">
                                                                    ...
                                                                    <div class="table-card">
                                                                        <form action="{{ route('deleteapprovejob', $appjob->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    ...
                                                                    <a href="{{ route('showjob', $appjob->id) }}" class="btn btn-md btn-light-primary px-3"><i class="fa-solid fa-eye"></i></a>
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
